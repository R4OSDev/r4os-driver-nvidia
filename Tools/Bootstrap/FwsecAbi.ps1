...
function Confirm-FwsecAbi([string]$Compiler,[string]$Source,[string]$Run,[string]$Stage){
    ...
    if(!$abi.gsp_core_register_original_comparison -or $abi.gsp_core_register_values -ne 30){throw 'GA106 core register comparison incomplete'}
    if(!$abi.falcon_hs_register_original_comparison -or $abi.falcon_hs_register_values -ne 34){throw 'GA106 HS Falcon register comparison incomplete'}
