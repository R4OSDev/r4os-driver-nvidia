...
pub fn build(b: *std.Build) void {
    ...
    const module = sdk.addR4MFWithOptions(b.path("module.R4MF"), .{ .zig_module_roots = &.{ receiver_parser_path, receiver_bridge_path, copy_encoder_path, render_encoder_path, nv_binding_path } });
